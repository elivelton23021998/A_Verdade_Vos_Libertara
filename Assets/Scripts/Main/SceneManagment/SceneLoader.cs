...
public class SceneLoader : MonoBehaviour
{
    ...
    [Tooltip("Mude de cena pressionando qualquer botão")]
    public bool SwitchManually;

    [Space(7)]

    [Tooltip("Prioridade de carregamento em segundo plano")]
    ...
    void Start()
    {
        ...
        else
        {
            ...
            Debug.LogError("Loading Error: Não há cena para carregar!");
        }
