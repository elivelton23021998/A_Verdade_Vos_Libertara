...
public class DragRigidbody : MonoBehaviour {
	...
	void Update()
	{
        ...
        {
            GrabButton = inputManager.GetInput("Pegar");
            ThrowButton = inputManager.GetInput("Arremeçar");
            rotateObject = inputManager.GetInput("Atirar");
        }
	...
	private void TryPickObject(){
        ...
        {
            Debug.LogError("[DragRigidbody] " + objectRaycast.name + " não contém um componente Rigidbody!");
            GrabObject = false;
            return;
        }
