...
public class InteractiveItem : MonoBehaviour, ISaveable {
    ...
    //AdvancedObject - Examinar
    [Tooltip("Colisores que serão desabilitados quando o objeto for examinado.")]
    public Collider[] CollidersDisable;
    [Tooltip("Colliders que serão habilitados quando o objeto for examinado.")]
