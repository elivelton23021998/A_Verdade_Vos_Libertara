...
/// <summary>
/// O GameManager principal
/// </summary>
public class AVVL_GameManager : Singleton<AVVL_GameManager> {
    ...
    void Update()
    {
        ...
        if (inputManager.HasInputs())
        {
            ...
            ThrowKey = inputManager.GetInput("Arremeçar");
            RotateKey = inputManager.GetInput("Atirar");
            CursorKey = inputManager.GetInput("Zoom");
            InventoryKey = inputManager.GetInput("Inventário");
        }
    ...
    /// <summary>
    /// Bloqueie alguns controles do player
    /// </summary>
    ...
    public void LockScript<T> (bool state) where T : MonoBehaviour
    {
        ...
        else
        {
            ...
            {
                Debug.LogError("Script " + typeof(T).Name + " não pode ser bloqueado");
            }
        }
    }
    ...
    public void AddPickupMessage(string itemName)
    {
        ...
        Message.GetComponent<Notification>().SetMessage(string.Format("Pegou {0}", itemName));
    }
    ...
    /// <summary>
    /// Mostrar botões da interface do usuário quando estiver examinando
    /// </summary>
    /// <param name="btn1">PutDown</param>
    /// <param name="btn2">Use</param>
    /// <param name="btn3">Rotate</param>
    /// <param name="btn4">Show Cursor</param>
    public void ShowExamineSprites(bool btn1 = true, bool btn2 = true, bool btn3 = true, bool btn4 = true, string PutDownText = "", string UseText = "Pegar")
    {
