...
public class NumberPadlock : MonoBehaviour, ISaveable
{
    ...
    [Tooltip("O código deve ter no máximo 3 dígitos! (999)")]
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Formato de código de desbloqueio incorretot!");
            return;
        }
    ...
    {
        isUnlocked = token["Desbloqueado"].ToObject<bool>();
